class MapController < ApplicationController
  ...
  def update_icon    
    ...
    #   countries << market[1]["country"]
    # end
    countries = ["Alaska", "Argentina", "Brazil", "Mexico", "Chile", "Peru", "Colombia", "Canada", "Austria", "Belgium", "France", "Germany", "Netherlands", "Norway", "Sweden", "Denmark", "Switzerland", "England", "Czeck Republic"]
